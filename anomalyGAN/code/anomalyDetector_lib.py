...
class AnomalyDetector:
    ...
    def train(self,use_wandb=False, wandb_projekt=None, wandb_run_name=None, wandb_sweep=False):
        ...
        earlyStopping = EarlyStopping(patience=self.patience,verbose=True, delta=0, path="best_model.pt")
        ...
        train_f1, train_precision, train_recall, train_auc_score,train_mse = self.eval_data_set(self.X_tensor, self.y_tensor, self.labels_tensor)
        ...
        plt.plot(self.training_losses_history,label="Training Loss")
        plt.plot(self.val_losses_history,label="Validation Loss")
